...
const Route_js_1 = __importStar(require("./Route.js"));
...
function throwSpecExceptions({ url, options: { headers, method, body }, }) {
    ...
    if ((0, RequestUtils_js_1.hasCredentialsInUrl)(url)) {
...
class Router {
    ...
    addRoute(matcher, response, nameOrOptions) {
        const config = {};
        if (matcher instanceof Route_js_1.RouteConfigWrapper) {
            Object.assign(config, matcher);
        }
        if ((0, Matchers_js_1.isUrlMatcher)(matcher)) {
            config.url = matcher;
        }
        else if ((0, Matchers_js_1.isFunctionMatcher)(matcher)) {
        ...
        const route = new Route_js_1.default({
            ...this.config,
            ...config,
        });
    ...
    setFallback(response) {
        ...
        this.fallbackRoute = new Route_js_1.default({
